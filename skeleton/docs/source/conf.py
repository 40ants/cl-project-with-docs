# -*- coding: utf-8 -*-
#
# <% @var name %> documentation build configuration file, created by
...
htmlhelp_basename = '<% @var name %>doc'
...
latex_documents = [
  ('index', '<% @var name %>.tex', u'<% @var name %> Documentation',
   u'<% @var author %>', 'manual'),
]
...
man_pages = [
    ('index', '<% @var name %>', u'<% @var name %> Documentation',
     [u'<% @var author %>'], 1)
]
...
texinfo_documents = [
  ('index', '<% @var name %>', u'<% @var name %> Documentation',
   u'<% @var author %>', '<% @var name %>', '<% @var description %>',
   'Miscellaneous'),
]
