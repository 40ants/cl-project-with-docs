# -*- coding: utf-8 -*-
#
# cl-project-with-docs documentation build configuration file, created by
...
cl_systems = [
    {
        'name': 'cl-project-with-docs-test',
...
project = u'cl-project-with-docs'
...
htmlhelp_basename = 'cl-project-with-docsdoc'
...
latex_documents = [
  ('index', 'cl-project-with-docs.tex', u'cl-project-with-docs Documentation',
...
man_pages = [
    ('index', 'cl-project-with-docs', u'cl-project-with-docs Documentation',
...
texinfo_documents = [
  ('index', 'cl-project-with-docs', u'cl-project-with-docs Documentation',
   u'Alexander Artemenko', 'cl-project-with-docs', 'Project skeleton generator which uses Sphinx and reStructured text.',
   'Miscellaneous'),
]
